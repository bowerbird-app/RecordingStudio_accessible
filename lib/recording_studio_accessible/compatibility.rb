...
module RecordingStudioAccessible
  ...
  module Compatibility
    ...
    CAPABILITY_SOURCE = "recording_studio_accessible"
    ...
    class << self # rubocop:disable Metrics/ClassLength
      ...
      def ensure_recordable_types_registered!
        ...
        ensure_access_capability_registered!
        ensure_access_recordable_declaration!
      end

      def ensure_access_capability_registered!
        return unless defined?(::RecordingStudio)
      ...
      def enable_access_capability!(recordable_or_type)
        return unless defined?(::RecordingStudio)

        ensure_access_capability_registered!
        RecordingStudio.enable_capability(ACCESS_CAPABILITY, on: recordable_or_type)
      end
