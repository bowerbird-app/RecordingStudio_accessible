...
module RecordingStudioAccessible
  ...
  #   RecordingStudioAccessible.configuration.hooks.after_initialize do
  #     Rails.logger.info "RecordingStudioAccessible initialized!"
  #   end
  #
  # @example Running hooks
  #   RecordingStudioAccessible::Hooks.run(:after_initialize)
  #
  class Hooks
    ...
    def log_hook_error(error, event_name, _hook)
      ...
      Rails.logger.error "[RecordingStudioAccessible::Hooks] Error in #{event_name} hook: #{error.message}"
    ...
    class << self
      ...
      # @return [Array] Results from all hooks
      def run(event_name, *)
        RecordingStudioAccessible.configuration.hooks.run(event_name, *)
      end
      ...
      def run_around(event_name, context, &)
        RecordingStudioAccessible.configuration.hooks.run_around(event_name, context, &)
      end
